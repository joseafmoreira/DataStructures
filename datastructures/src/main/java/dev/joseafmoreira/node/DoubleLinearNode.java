...
/**
 * A double linear node is an auxiliary object used to implement a double linked
 * abstract data type.
 * It contains an {@link #element}, a pointer to the {@link #prev} double linear
 * node and
 * a pointer to the {@link #next} double linear node.
 * <p>
 * 
 ...
 * an element</li>
 * <li>
 * {@link #DoubleLinearNode(Object, DoubleLinearNode, DoubleLinearNode)}:
 * Constructs a double linear node with an element,
 * a reference to the prev double linear node and a reference to the next double
 * linear node
 * </li>
 * </ul>
 * 
 ...
 * <p>
 * <ul>
 * <li>{@link #getPrev()}: Returns the reference stored in this double linear
 * node prev pointer</li>
 * <li>{@link #setPrev(DoubleLinearNode)}: Sets the reference stored in this
 * double linear node prev pointer</li>
 * <li>{@link #getNext()}: Returns the reference stored in this double linear
 * node next pointer</li>
 * <li>{@link #setNext(DoubleLinearNode)}: Sets the reference stored in this
 * double linear node next pointer</li>
 * <li>{@link #hashCode()}: Returns the hash code value for this double linear
 * node</li>
 * <li>{@link #equals(Object)}: Compares this double linear node with the
...
public class DoubleLinearNode<T> extends LinearNode<T> {
    ...
    /**
     * Constrcuts a double linear node with an element, a reference to the prev
     * double linear node
     ...
     * 
     * @param prev the reference to be stored in this double linear node next
     *             pointer
     */
     ...
     * @return true if the specified object is equal to this double linear node,
     *         false otherwise
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (prev == null && other.prev != null || prev != null && !prev.equals(other.prev))
            return false;

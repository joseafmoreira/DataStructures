...
/**
 * A collection is an abstract data type that is a grouping of items that can be used in a 
 * polymorphic way. <p>
 * 
 * The common operations for a collection include: <p>
 * <ul>
 *  <li>{@link #clear()}: Removes all the elements from this collection</li>
 *  <li>{@link #isEmpty()}: Checks if this collection is empty</li>
 *  <li>{@link #size()}: Returns the number of elements present in this collection</li>
 *  <li>{@link #equals(Object)}: Indicates whether some other object is "equal to" this collection</li>
 *  <li>{@link #hashCode()}: Returns a hash code value for this collection</li>
 *  <li>{@link #toString()}: Returns a string representation of this collection</li>
 * </ul>
 * 

 ...
 * of a tree,
 * every node, with the exception of the root node, has exactly one parent and,
 * at max,
 * two children.
 * <p>
 * There will be three base types of binary trees implemented:
 * <p>
 * <ul>
 * <li>Search</li>
 * <li>Min-heap</li>
 ...
 * binary trees leaving the
 * unique methods for the search, the min-heap and the max-heap binary trees in
 * the
 * {@code BinarySearchTreeADT}, {@code MinHeapADT} and {@code MaxHeapADT}
 * respectively
 * 
 ...
 * tree</li>
 * <li>{@link #find(Object)}: Returns a specified element if it is found in this
 * binary tree</li>

 ...
 *  <li>{@link #addBefore(Object, Object)}: Adds an element before a specified target in this unordered list</li>
 *  <li>{@link #addAfter(Object, Object)}: Adds an element after a specified target in this unordered list</li>
 *  <li>{@link #add(int, Object)}: Inserts the specified element at the specified index in this list</li>
 * </ul>
 * 
...
public interface UnorderedListADT<T> extends ListADT<T> {
     ...
     *         null and this list does not allow null elements

 ...
 * {@code Iterator} object. <p>
 * 
 * The common operations for an iterable collection include: <p>
 * <ul>
 *  <li>{@link #contains(Object)}: Returns true if this collection contains the specified target</li>
 *  <li>{@link #toArray()}: Returns an array containing all of the elements in this collection</li>
 *  <li>{@link #iterator()}: Returns an iterator over the elements in this collection</li>
 * </ul>
 * 
...
public interface IterableCollectionADT<T> extends CollectionADT<T>, Iterable<T> {
     ...
     * @return true if this collection contains the specified target, false otherwise
